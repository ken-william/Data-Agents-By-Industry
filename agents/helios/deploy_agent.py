#!/usr/bin/env python3
"""
Deployment script for Helios BigQuery Data Agent using geminidataanalytics.googleapis.com API.
"""
...
def deploy_helios_agent():
    ...
    if response.status_code in [200, 201]:
        print(f"✅ Successfully created Helios Data Agent! (ID: {agent_id})")
        ...
        if patch_response.status_code in [200, 201]:
            print(f"✅ Successfully updated Helios Data Agent configuration! (ID: {agent_id})")
        else:
