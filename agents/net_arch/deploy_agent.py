#!/usr/bin/env python3
"""
Deployment script for NetArch BigQuery Data Agent using geminidataanalytics.googleapis.com API.
"""
...
def deploy_net_arch_agent():
    ...
    if response.status_code in [200, 201]:
        print(f"✅ Successfully created NetArch Data Agent! (ID: {agent_id})")
        ...
        if patch_response.status_code in [200, 201]:
            print(f"✅ Successfully updated NetArch Data Agent configuration! (ID: {agent_id})")
        else:
